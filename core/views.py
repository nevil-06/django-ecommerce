...
class CategoryView(View):
    def get(self, *args, **kwargs):
        ...
        sorting = self.request.GET.get('sorting', '')  # Get sorting parameter from query string

        # Filter items based on category and active status
...
def history_view(request):
    ...
    if today in visit_history:
        visit_history[today] += 1
    else:
        visit_history[today] = 1
